...
if(isset($_POST['Submit'])){
	...
	$new_insurance = $_POST['insurance'];
	$new_insurance_date = $_POST['insurance_date'];
	$new_technical_review = $_POST['technical_review'];
	$new_technical_review_date = $_POST['technical_review_date'];
	$new_taxes= $_POST['taxes'];
	$new_taxes_date= $_POST['taxes_date'];
	
	$sql = "INSERT INTO year_payments (userId, pay_insurance, pay_insurance_date, pay_technical_review, pay_technical_review_date, pay_taxes, pay_taxes_date) 
	VALUES ('$userid', '$new_insurance', '$new_insurance_date', '$new_technical_review', '$new_technical_review_date', '$new_taxes', '$new_taxes_date')";
...
<div id="wrapper">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="panels.html" class=""></i> <span>Годищни плащания</span></a></li>
						<li><a href="panels.html" class=""></i> <span>Консумативи</span></a></li>
		...
		<div class="main">
		<form action ="yearpayments.php" name="myform1" method = "POST">
			<!-- MAIN CONTENT -->
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Годишни плащания</h3>
					<div class="row">
						<div class="col-md-6">
					
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Гражданска отговорност</h3>
									<input type="date" class="form-control"  name = "insurance" placeholder="">
									<input type="date" class="form-control"  name = "insurance_date" placeholder="">
								</div>
							</div>
								...
								<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Годишен технически преглед</h3>
									<input type="date" class="form-control" name = "technical_review" placeholder="">
									<input type="date" class="form-control" name = "technical_review_date" placeholder="">
								</div>
								</div>
								
								<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Данък МПС</h3>
									<input type="date" class="form-control" name = "taxes" placeholder="">
									<input type="date" class="form-control" name = "taxes_date" placeholder="">
								</div>
								</div>
